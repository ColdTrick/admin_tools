...
return array (
  ...
  'admin_tools:switch_to_user' => 'Wordt gebruiker',
  'admin_tools:switch_to_admin' => 'Wordt beheerder',
  ...
  'admin_tools:action:toggle_admin:success:user' => 'Je bent nu een normale gebruiker',
  'admin_tools:action:toggle_admin:success:admin' => 'Je bent nu weer een beheerder',
);
